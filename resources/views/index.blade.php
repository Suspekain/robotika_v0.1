  ...
  <body id="top">
    <header>
      <div class="container pt-4">
        <nav class="navbar navbar-expand-lg navbar-dark bg-transparent px-0"><a class="text-white navbar-brand" href="#">Ro-Botika</a>
          ...
          <div class="collapse navbar-collapse text-uppercase" id="da-navbarNav">
            <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item"><a class="nav-link smooth-scroll" href="#projects">Proyectos</a></li>
              <li class="nav-item"><a class="nav-link smooth-scroll" href="#gallery">Galeria</a></li>
      ...
      <div class="da-home-page-text" data-aos="fade-right" data-aos-duration="1000">
        <div class="container">
          <div class="col-md-10 col-sm-12 px-0 mx-0">
            <h2 class="display-3" style="margin-left:-6px;">RO-BOTIKA</h2>
            <h3 class="h5 mt-3">El servicio autonomo que necesitas, para una plena tranquilidad</h3><a class="smooth-scroll btn btn-outline-light mt-4" href="#learn">Saber mas</a>
          </div>
        </div>
      </div>
    </header>
...
<div class="da-section da-work bg-secondary" id="learn">
  <div class="container">
    <div class="h3 pb-3 text-center text-white" data-aos="fade-up">¿Por que contratar nuestro producto?</div>
    <p class="px-5 pb-5 text-center text-white" data-aos="fade-up">Existen muchas razones por las que podrias contratar nuetros servicios, y estos son los mas destacables.</p>
    <div class="row">
      <div class="col-md-4">
        <div class="card mb-3" data-aos="flip-left">
          <div class="card-body mt-4 mb-1 text-center"><i class="pb-3 text-primary fas fa-briefcase fa-3x"></i>
            <div class="h4 pb-3">Profesionalidad</div>
            <p>Contamos con una plantilla de programadores, electronicos y mecanicos expertos.</p>
          </div>
        </div>
      </div>
      <div class="col-md-4">
        <div class="card mb-3" data-aos="zoom-in-up">
          <div class="card-body mt-4 mb-1 text-center"><i class="pb-3 text-primary fas fa-sliders-h fa-3x"></i>
            <div class="h4 pb-3">Escalabilidad</div>
            <p>Hemos creado un diseño con el cual no hay limite de ampliacion de dicho producto.</p>
          </div>
        </div>
      </div>
      <div class="col-md-4">
        <div class="card mb-3" data-aos="flip-right">
          <div class="card-body mt-4 mb-1 text-center"><i class="pb-3 text-primary fas fa-trophy fa-3x"></i>
            ...
            <p>Contamos con una exitosa carrera, en la cual hemos recibido varios premios de innovacion.</p>
          </div>
        </div>
      </div>
    </div>
          ...
          <div class="card mb-3">
            <div class="card-body py-5" data-aos="zoom-in" data-aos-duration="500">
              <div class="text-primary"><i class="pb-3 fas fa-code fa-3x"></i>
                <p class="font-weight-bold">Diseño Web</p>
              </div>
              <p>Generamos codigo optimo, efectivo y funcional</p>
            </div>
          </div>
        </div>
        <div class="col-lg-3 col-md-6">
          <div class="card mb-3">
            <div class="card-body py-5" data-aos="zoom-in" data-aos-duration="1000">
              <div class="text-primary"><i class="pb-3 fab fa-buromobelexperte fa-3x"></i>
                <p class="font-weight-bold">Diseño grafico</p>
              </div>
              <p>Contamos con una interfaz grafica limpia e intuitiva.</p>
            </div>
          </div>
        </div>
        <div class="col-lg-3 col-md-6">
          <div class="card mb-3">
            <div class="card-body py-5" data-aos="zoom-in" data-aos-duration="1500">
              <div class="text-primary"><i class="pb-3 fas fa-cubes fa-3x"></i>
                <p class="font-weight-bold">Adaptable</p>
              </div>
              <p>El sistema se adapta facilmente a cualquier hospital</p>
            </div>
          </div>
        </div>
        <div class="col-lg-3 col-md-6">
          <div class="card mb-3">
            <div class="card-body py-5" data-aos="zoom-in" data-aos-duration="2000">
              ...
              <p>En todo momento podran contar con el soporte oficial</p>
            </div>
          </div>
        </div>
      </div>
  ...
  <div class="row mx-0">
    ...
    <div class="col-md-6 pl-5 pt-5 pb-3">
      <div class="row">
        ...
        <div class="col-10">
          <div class="h4">Enfermeros</div>
          <p>Gracias a nustro sistema innovador, los enfermeros y las enfermeras podran gozar de una jornada laboral con menos exigencias</p>
        </div>
      </div>
      <div class="row mb-3">
        <div class="col-1 da-project-icon"><i class="text-info fas fa-book fa-2x fa-fw"></i></div>
        <div class="col-10">
          <div class="h4">Documentacion</div>
          <p>Todo nuestro software cuenta con una documentacion intuitiba y facil de consultas, en el caso de que haya alguna duda.</p>
        </div>
      </div>
      ...
      <div class="col-md-3 col-sm-6">
        <div class="media py-2" data-aos="flip-up"><i class="mr-3 fas fa-clipboard-check  fa-3x fa-fw"></i>
          <div class="media-body">
            <div class="h5">17</div>
            <div class="h6">Hospitales activos</div>
          </div>
        </div>
      </div>
      <div class="col-md-3 col-sm-6">
        <div class="media py-2" data-aos="flip-up"><i class="mr-3 fas fa-smile  fa-3x fa-fw"></i>
          <div class="media-body">
            ...
            <div class="h6">Usuarios contentos</div>
          </div>
        </div>
      </div>
      <div class="col-md-3 col-sm-6">
        <div class="media py-2" data-aos="flip-up"><i class="mr-3 fas fa-file-alt fa-3x fa-fw"></i>
          <div class="media-body">
            <div class="h5">38</div>
            <div class="h6">Incidencias resueltas</div>
          </div>
        </div>
      </div>
      <div class="col-md-3 col-sm-6">
        <div class="media py-2" data-aos="flip-up"><i class="mr-3 fas fa-clock  fa-3x fa-fw"></i>
          <div class="media-body">
            ...
            <div class="h6">Horas trabajadas</div>
          </div>
        </div>
      </div>
    </div>
...
<div class="da-section">
  <div class="container da-company-brand py-5">
    <div class="h3 pb-3 text-uppercase text-center" data-aos="fade-up">Nuestros clientes</div>
    <p class="pb-3 text-center" data-aos="fade-up">Clientes relevantes mas satisfechos</p>
    <div class="row">
  ...
  <div class="da-contact-detail" data-aos="zoom-in" data-aos-duration="1000">
    <div class="container">
      <div class="card py-4 px-4">
        <div class="h4 pb-4">Contactenos</div>
        <div class="row">
          ...
          <div class="col-md-5">
            <p><b>Direccion:</b> Avenida navarra, 23</p>
            <p><b>Telefono:</b> +34 666-666-666</p>
            <p><b>Email:</b> info@ro-botika.com</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <footer class="bg-secondary da-section">
      <div class="container text-white">
        <div class="row">
          <div class="col-md-4">
            <div class="h2">Hola!</div>
            <p class="mb-0">info@ro-botika.com</p>
            <p>+34 666-666-666</p>
          </div>
          <div class="col-md-4">
            <div class="h6 pb-2">Siguenos</div>
            <ul>
              <li><a class="da-social-link" href="https://www.twitter.com">Twitter</a></li>
              <li><a class="da-social-link" href="https://www.twitter.com">Facebook</a></li>
              <li><a class="da-social-link" href="https://www.twitter.com">Instagram</a></li>
              <li><a class="da-social-link" href="https://www.twitter.com">Google</a></li>
            </ul>
          </div>
          <div class="col-md-4">
            <div class="h6 pb-2">Copyright</div>
            <p>&copy; 2019 - 2020 Ro-Botika S.L. All rights reserved.</p>
          </div>
        </div>
      </div>
    </footer>
